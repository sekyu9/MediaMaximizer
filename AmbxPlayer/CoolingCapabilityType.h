#ifndef __CoolingCapabilityType_h__
#define __CoolingCapabilityType_h__
...
class CoolingCapabilityType : public SensoryDeviceCapabilityBaseType
{
public:
	CoolingCapabilityType(ElementBaseType* e);
	virtual ~CoolingCapabilityType() {};
	void mappingData();
